                ...
                <div className="col-span-6 md:col-span-4 bg-white p-4 border ">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-3 items-center justify-center text-sm">
                            <div
                                className={`bg-muted p-1 rounded-sm w-10 text-center ${selectedFilter === 'ALL' ? 'bg-slate-500/50 shadow-md' : ''
                                    }`}
                            ...
                            <div
                                className={`bg-muted p-1 rounded-sm w-10 text-center ${selectedFilter === '1M' ? 'bg-slate-500/50 shadow-md' : ''
                                    }`}
                            ...
                            <div
                                className={`bg-muted p-1 rounded-sm w-10 text-center ${selectedFilter === '6M' ? 'bg-slate-500/50 shadow-md' : ''
                                    }`}
                            ...
                            <div
                                className={`bg-muted p-1 rounded-sm w-10 text-center ${selectedFilter === '1Y' ? 'bg-slate-500/50 shadow-md' : ''
                                    }`}
